...
const Add = ({ token }) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} action="" method="post" className="flex flex-col w-full items-start gap-3">
      <div>
      ...
      <button className="w-28 py-3 mt-4 bg-black text-white cursor-pointer">ADD</button>
    </form>
  );
};
